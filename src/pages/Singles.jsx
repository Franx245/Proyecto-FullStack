...
function buildServerSideFilters(filters, primaryFilter, useServerFallback) {
  ...
  return {
    rarities: primaryFilter.kind === "rarities" ? [primaryFilter.value] : [],
    cardTypes: primaryFilter.kind === "cardTypes" ? [primaryFilter.value] : [],
    conditions: primaryFilter.kind === "conditions" ? [primaryFilter.value] : [],
    sets: primaryFilter.kind === "sets" ? [primaryFilter.value] : [],
    priceRange: primaryFilter.kind === "priceRange" ? primaryFilter.value : null,
  };
}
...
export default function Singles() {
  ...
  const initialCatalogSnapshot = useMemo(
    () => getInitialCatalogSnapshot({
      ...
      priceRange: serverFilters.priceRange,
    }),
