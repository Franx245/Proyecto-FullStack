...
export default function CheckoutResult() {
  ...
  return (
    <motion.section
      ...
      className="mx-auto max-w-[760px] px-4 py-10"
    >
      <div className="overflow-hidden rounded-[32px] border border-border bg-card/80 p-8 shadow-[0_24px_80px_rgba(0,0,0,0.24)]">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link to="/orders" className="inline-flex h-11 items-center justify-center rounded-2xl bg-primary px-5 text-sm font-bold text-primary-foreground">
            Ir a Mis Pedidos
          </Link>
          <Link to="/cart" className="inline-flex h-11 items-center justify-center rounded-2xl border border-border px-5 text-sm font-semibold transition hover:bg-secondary">
            Volver al carrito
          </Link>
        </div>
      </div>
