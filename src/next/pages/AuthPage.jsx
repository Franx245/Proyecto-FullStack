      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
          <div className="rounded-[32px] border border-border bg-card/70 p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.24)]">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <button onClick={() => router.push("/account")} className="btn-primary rounded-2xl px-5 py-3">Ir a mi cuenta</button>
              <button onClick={() => router.push(redirectTo)} className="rounded-2xl border border-border px-5 py-3 text-sm font-semibold transition hover:bg-secondary">Continuar</button>
              <button onClick={() => switchTab("admin")} className="rounded-2xl border border-border px-5 py-3 text-sm font-semibold transition hover:bg-secondary">Ingresar como admin</button>
            </div>
          </div>
        </div>
    );
