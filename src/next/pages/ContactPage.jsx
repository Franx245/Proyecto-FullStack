          ...
          <div className="grid lg:grid-cols-[0.94fr_1.06fr]">
            <div className="border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.2),transparent_42%),linear-gradient(180deg,rgba(15,23,42,0.95),rgba(12,20,34,1))] p-4 sm:p-6 lg:border-b-0 lg:border-r">
              ...
              <div className="mt-4 grid gap-3 sm:mt-5 sm:gap-4">
                ...
                <button onClick={handleWhatsApp} className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[#08b23f] px-4 text-sm font-bold text-white shadow-[0_16px_35px_rgba(8,178,63,0.28)] transition hover:bg-[#079739] active:scale-[0.99]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea placeholder="Escribe tu mensaje aquí..." rows={4} value={form.message} onChange={(event) => setForm((prev) => ({ ...prev, message: event.target.value }))} className="w-full resize-none rounded-2xl border border-slate-700/80 bg-slate-950/45 py-3 pl-10 pr-4 text-sm text-slate-100 placeholder:text-slate-500 focus:border-amber-300/35 focus:outline-none focus:ring-4 focus:ring-amber-300/10" />
                    </div>
                  </div>
                  ...
                  <button type="submit" disabled={loading} className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-amber-400 text-sm font-bold text-slate-950 transition hover:bg-amber-300 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-40">
